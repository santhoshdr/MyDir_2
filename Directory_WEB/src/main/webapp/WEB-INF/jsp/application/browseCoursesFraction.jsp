				...
				<c:forEach items="${courses}" var="course">
					<li>
						<div class="item-avatar">
							<a href="${initParam.resourcePath}/../viewIndividualCourse.htm?courseId=${course.courseId}" title="${course.name} View Details"><img
						...
						<div class="item">
							<div class="item-title">
								<a href="${initParam.resourcePath}/../viewIndividualCourse.htm?courseId=${course.courseId}">${course.name}</a>
							</div>
							<div class="item-meta">
								<div class="star-rating">
									<c:set value="${course.rating}" var="rating" scope="request"/>
									<c:import  url="/WEB-INF/jsp/application/displayRating.jsp"/>
									( <a href="${initParam.resourcePath}/../viewReviews.htm?courseId=${course.courseId}"><strong itemprop="count">
							...
							<div class="item-credits">
								...
								<div class="right">
									<a href="${initParam.resourcePath}/../viewIndividualCourse.htm?courseId=${course.courseId}"
									...
									<a class="lnk-button lnk-blue add-to-cart" id="purchaseCourse"  href="${initParam.resourcePath}/../s/purchaseCourse.htm?courseId=${course.courseId}"
									title="${initParam.resourcePath}/../s/purchaseCourse.htm?courseId=${course.courseId}">Purchase For Free</a>
								</div>
							</div>
							<div class="clear"></div>
						</div>
