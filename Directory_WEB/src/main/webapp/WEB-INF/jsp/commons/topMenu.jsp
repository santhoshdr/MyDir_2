	...
	<div id="headerSticky">
		<div class="stickyCenter">
			<div class="app-center">
				...
				<div class="top-right">
					<div class="support">
						<a class="btn btn-green btn-login" href="${initParam.resourcePath}/../browseCourses.htm">Browse Courses topMenu.jsp</a>
						<c:if test="${sessionScope.userDetails!=null}">
							<c:if test='${userDetails.role.contains("ROLE_ADMIN")}'>
								<a class="btn btn-green btn-login" href="${initParam.resourcePath}/../adm/allFunctionalities.htm">Admin Funcs</a>
							</c:if>
							<c:if test='${userDetails.role.contains("ROLE_MYUSER")}'>
								<a class="btn btn-green btn-login" href="${initParam.resourcePath}/../s/referFriends.htm">Refer Friends</a>
							</c:if>
						</c:if>
					</div>
					...
					<c:if test="${sessionScope.SPRING_SECURITY_CONTEXT!=null}">
						<a  href="${initParam.resourcePath}/../logout.htm" class="btn btn-green btn-login">Sign Out</a>
					</c:if>
				</div>
			</div>
